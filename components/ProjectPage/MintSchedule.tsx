    ...
    <div className="flex items-stretch gap-2 w-full" {...rest}>
      ...
      <Collapsible
        ...
        <div className="rounded-2xl bg-surface-soft p-4 my-4 flex flex-col gap-2">
          ...
          <p className="text-body-12 text-secondary">Start: {format(round.start, 'yyyy/M/dd - hh:mm a')}</p>
          <p className="text-body-12 text-secondary">End: {format(round.end, 'yyyy/M/dd - hh:mm a')}</p>
